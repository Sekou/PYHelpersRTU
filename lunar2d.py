...
def drawRotRect(screen, color, pc, w, h, ang): #точка центра, ширина высота и угол поворота прямогуольника
    ...
    while True:
        for ev in pygame.event.get():
            ...
            if ev.type == pygame.KEYDOWN:
                if ev.key == pygame.K_w: lm.gas=[0.5, 0.5, 0.5, 0.5]
                if ev.key == pygame.K_d: lm.gas=[0, 0, 0.1, 0.1]
                if ev.key == pygame.K_a: lm.gas=[0.1, 0.1, 0, 0]
